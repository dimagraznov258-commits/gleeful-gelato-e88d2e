...
e.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.LEFT),"TelephoneNumberButton"==e.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),e.addTo(this.extended),e.hint=!1)}b<this.buttonCount&&(this.btnMore.addTo(this.container.body),this.btnMore.setPosition(a,this.buttonTop))},addPageButtons:function(a){function b(n){n.addTo(e);n.setPosition(f,h);f+=g}function c(){f+=k;0<d?(l.css({left:f+"px",top:m+"px",width:d+"px",display:"block"}),l.find("input").css({width:d+
"px"}),f+=d):l.css({display:"none"});f+=k}var d=this.edtNumber.width,e=this.container.body,f=a,g=this.buttonWidth,h=this.buttonTop,l=this.edtNumber.body,m=this.edtNumber.top,k=this.edtNumber.space;rightToLeft?(bookConfig.enablePageBack&&b(this.btnForward),b(this.btnLast),b(this.btnNext),c(),b(this.btnPrevious),b(this.btnFirst),bookConfig.enablePageBack&&b(this.btnBackward)):(bookConfig.enablePageBack&&b(this.btnBackward),b(this.btnFirst),b(this.btnPrevious),c(),b(this.btnNext),b(this.btnLast),bookConfig.enablePageBack&&
